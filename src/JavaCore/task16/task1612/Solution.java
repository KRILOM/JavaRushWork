package JavaCore.task16.task1612;
...
//•	Метод doStep должен учитывать скорость бегуна.
//  Если скорость бегуна 2 шага в секунду, метод должен работать пол секунды; если скорость бегуна 4 шага в секунду, метод должен работать четверть секунды.
